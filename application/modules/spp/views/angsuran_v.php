...
<div class="page-content">
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Tagihan Angsuran Mahasiswa</span><span style="font-size : 11pt ;"> >> Pengelolaan Data per Periode per Mahasiswa</span></span></h3>
        </div>
            ...
            <div class="col-md-12">
                <div class="grid simple">
                    <div class="grid-title no-border">
                        <h4>Tagihan Angsuran Mahasiswa <a href="<?php echo base_url() . 'spp/tagihan/' . $kode_periode; ?>"><?php echo $label_nama_periode . $label_jenjang; ?></a> >
                    ...
                    <div class="grid-body no-border">
                        <div class="row-fluid">
                            ...
                            <div class="span3 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        echo form_dropdown('kode_fakultas', $ref_fakultas, set_value('kode_fakultas', $tagihan["kode_fakultas"]), array('class' => 'chosen-select form-select drop_select fakultas', 'style' => 'width:100%', 'disabled' => 'disabled'));
                                        ?>
                                    </div>
                                    <div class="error_msg col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        echo form_dropdown('kode_prodi', $ref_prodi, $tagihan['kode_prodi'], array('class' => 'chosen-select form-select drop_select prodi', 'style' => 'width:100%', 'disabled' => 'disabled')); ?>
                                    </div>
                                    <div class="error_msg col-sm-3">
                            ...
                            <div class="span4 col-sm-6" style="display:block">
                                ...
                                <hr>
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="nama">Total Tagihan</label>
                                    <div class="col-sm-6">
                                        <label id="total_tagihan" class="control-label" style="text-align:left;">Rp. 0,-</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="nama">Sudah Dibayar</label>
                                    <div class="col-sm-6">
                                        <label id="sudah_dibayar" class="control-label" style="text-align:left;">Rp. 0,-</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="nama">Angsuran Ke</label>
                                    <div class="col-sm-6">
                                        <label id="angsuran_ke" class="control-label" style="text-align:left;">Rp. 0,-</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class='input-group date'>
                                            <?php echo form_input('waktu_berlaku', set_value('waktu_berlaku', $tagihan["waktu_berlaku"]), array('class' => 'form-control waktu_berlaku', 'id' => 'waktu_berlaku', 'placeholder' => 'Tanggal mulai tagihan')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class='input-group'>
                                            <?php echo form_input('waktu_berakhir', set_value('waktu_berakhir', $tagihan["waktu_berakhir"]), array('class' => 'form-control waktu_berakhir', 'id' => 'waktu_berakhir', 'placeholder' => 'Tanggal akhir tagihan')); ?>
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        <?php if ($mode_input == "add") { ?>
            ...
            $('.nomor_induk').focusout(function() {
                if ($(this).val() != "") {
                    $('.fa-spinner').show();
                    $.ajax({
                        url: "<?php echo base_url(); ?>spp/cek_tagihan_angsuran",
                        type: 'POST',
                        data: {
                        ...
                        success: function(res) {
                            ...
                            if (data.status) {
                                if (data.data.nomor_pembayaran == 'AFK') {
                                    ...
                                    $('#total_tagihan').text(data.data.total_tagihan);
                                    $('#sudah_dibayar').text(data.data.sudah_dibayar);
                                    $('#angsuran_ke').text(data.data.angsuran_ke);
        ...
        $("#btn-upload").click(function() {
            ...
            form_data.append("keterangan", 'UKT');
