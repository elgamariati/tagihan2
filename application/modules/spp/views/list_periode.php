                        ...
                        <div class="grid-body col-md-4 card_<?php echo $row->kode_periode;?>">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo base_url() . "spp/tagihan/" . $row->kode_periode; ?>" class="btn btn-primary">Kelola Tagihan</a>
                                    <a href="<?php echo base_url() . "spp/bypasspembayaran/pembayaran/" . $row->kode_periode; ?>" class="btn btn-primary">Kelola Pembayaran</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" >
                <h5 id="modal-title">Salin Tagihan <?php echo $label_jenjang?></h5>
            </div>
            <div class="modal-body">
                 <div class="form-group col-lg-12 col-md-12 ">
                    <div class="row">
