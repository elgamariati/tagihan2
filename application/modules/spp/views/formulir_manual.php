...
<div class="page-content">
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Input Tagihan UKT Mahasiswa Lama</span><span style="font-size : 11pt ;"> >> Pengelolaan Data per Periode per Mahasiswa</span></span></h3>
        </div>
            ...
            <div class="col-md-12">
                <div class="grid simple">
                    <div class="grid-title no-border">
                        <h4>Input Tagihan UKT Mahasiswa Lama <a href="<?php echo base_url() . 'spp/tagihan/' . $kode_periode; ?>"><?php echo $label_nama_periode . $label_jenjang; ?></a> >
                            <?php echo (isset($tagihan['id_record_tagihan']) && $tagihan["id_record_tagihan"] != "" ? "Edit" : "Tambah") ?></h4>
                        <div class="tools">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span4 col-sm-6" style="display:block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <?php echo form_input('total_nilai_tagihan', str_replace(".", "", set_value('total_nilai_tagihan', $tagihan["total_nilai_tagihan"] ?? "0")), array('class' => 'form-control total_nilai_tagihan', 'placeholder' => 'Isikan rupiah tagihan')); ?>
                                    </div>
                                    <div class="error_msg col-sm-3">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="nama">Cicilan</label>
                                    <div class="col-sm-6">
                                        <?php
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="nama">Keringanan UKT</label>
                                    <div class="col-sm-6">
                                        <?php echo form_checkbox('keringanan_ukt', '1', set_value('keringanan_ukt', $tagihan["keringanan_ukt"] ?? ""), array('class' => 'keringanan_ukt', 'style' => 'margin-top:10px', 'readonly' => 'false')); ?>
                                    </div>
                                    <div class="error_msg col-sm-3">
                                        <?php echo (form_error('keringanan_ukt') != "" ? "Wajib diisi" : ""); ?>
                                    </div>
                                </div>
                                <div class="form-group">
