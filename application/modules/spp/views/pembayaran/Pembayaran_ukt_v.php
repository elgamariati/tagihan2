...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Pembayaran UKT</span><span style="font-size : 11pt ;"> >> Daftar Pembayaran</span></h3>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
            <div class="dropdown" style="float : right ; margin-right : -14px">
                <a class="btn btn-primary" href="<?php echo base_url('spp/pembayaran/download_xls/' . $kode_periode . '/UKT') ?>"> <span class="fa fa-download"></span> Unduh XLS</a>
            ...
            <div class="span12">
                <div class="grid simple ">
                    <div class="grid-title">
                        <h4>Daftar Pembayaran UKT <?php echo $label_nama_periode . $label_jenjang; ?></h4>
                        <div class="tools">
