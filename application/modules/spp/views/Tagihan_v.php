...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Tagihan UKT</span><span style="font-size : 11pt ;"> >> Pengelolaan Data per Semester</span></h3>
        </div>
            ...
            <div class="span12">
                <div class="grid simple ">
                    <div class="grid-title">
                        <h4>Daftar Tagihan UKT <?php echo $label_nama_periode . $label_jenjang; ?></h4>
...
<script>
    ...
    function detail(id) {
        console.log("<?php echo base_url('spp/detail/'); ?>" + id);
        $('#myDetail').modal("show");
        $.ajax({
    ...
    function unduh_template() {
        window.open('<?php echo base_url(); ?>spp/download_tagihan')
    }
</script>