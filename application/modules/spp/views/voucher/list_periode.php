...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-8 col-md-8 col-sm-8 col-xs-8">
            ...
            <h3><span class="semi-bold">SPP/UKT</span><span style="font-size : 11pt ;"> Manajemen pembayaran untuk SPP/UKT.</span></h3>

        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="dropdown" style="float : right ; margin-right : -14px">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-setting"></i></i> Menu Operasi
                    <span class="caret"></span></button>
                <ul class="dropdown-menu pull-right">
                    <!--<li class="dropdown-header">Manual Input</li>
                    <li><a href="#" onclick="dialog_tambah();">Tambah Periode</a></li>
                     <li role="presentation" class="divider"></li>-->
                    <li class="dropdown-header" style="padding-left: 10px">Mode Tagihan</li>
                    <li><a href="<?php echo base_url() . "spp/"; ?>">Daftar Tagihan</a></li>
                    <li><a href="<?php echo base_url() . "spp/mahasiswa"; ?>">Mahasiswa</a></li>
                    <li class="dropdown-header"  style="padding-left: 10px">Copy Data</li>
                    <li><a href="#" onclick="dialog_copy();">Copy</a></li>
