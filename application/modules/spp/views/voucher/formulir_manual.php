                ...
                <div class="col-md-12">
                    <div class="grid simple">
                        <div class="grid-title no-border">
                            <h4>Tagihan <a href="<?php echo base_url().'spp/tagihan/'.$kode_periode;?>"><?php echo $label_nama_periode;?></a> > 
                                <?php echo ($tagihan["id_record_tagihan"]!=""?"Edit":"Tambah Baru")?> <span class="semi-bold">Tagihan</span></h4>
                            <div class="tools">
