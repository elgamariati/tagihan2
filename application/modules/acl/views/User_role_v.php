...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <h3><span class="semi-bold">Role Pengguna</span><span style="font-size : 11pt ;"> >> Master</span></h3>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 nopad">
            <button class="btn btn-primary pull-right" type="button" id="btn-tambah" onclick="tambah()"> Tambah Role Pengguna</button>
        </div>
        <div class=" row">
            &nbsp
        </div>
...
<script>
    ...
    function tambah(key = "", nama = "") {
        Swal.fire({
            ...
            html: `
                Role
                <input class="form-control" type="text" id="role" value="` + key + `"/>
                <p id="roles" name="inVal" style="padding:10px;margin-bottom:0px;" hidden></p><br>

                Nama
                <input class="form-control" type="text" id="roleNama" value="` + nama + `"/>
                <p id="roleNamas" name="inVal" style="padding:10px;margin-bottom:0px;" hidden></p><br>
                `,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function tambah_req(key = null) {
        ...
        form_data.append("roleNama", $('#roleNama').val());
        if (key) {
            form_data.append("key", key);
        }
