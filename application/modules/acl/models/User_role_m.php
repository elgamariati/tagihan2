...
{
    var $table = 'pembayaran_user_role';
    var $column_order = array(null, 'role', 'roleNama'); //set column field database for datatable orderable 
    var $column_search = array('role', 'roleNama'); //set column field database for datatable searchable 
    ...
    {
        if ($this->dbSimari->where('role', $key)->delete($this->table)) {
            return array(
                "status" => true,
