 ...
 <div class="page-content">
    ...
    <div class="content">
       <div class="page-title col-lg-8 col-md-8 col-sm-8 col-xs-8">
          ...
          <h3><span class="semi-bold">User</span><span style="font-size : 11pt ;"> Manajemen user dan password aplikasi.</span></h3>
       </div>
...
<div id="modal-form" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" ><h5 id="modal-title">Tambah User</h5></div>
            <div class="modal-body">
