 ...
 <div class="page-content">
     ...
     <div class="content">
         ...
         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
             <a href="/cicilan/tambah" data-toggle="modal" class="btn btn-primary btn-cons" style="float : right ; margin-right : -14px"><i class="fa fa-plus ico-space"></i></i><span>Tambah Data</span></a>
         </div>
