        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="nopad col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <?php
                    $ref_jnsKode = array("UKT" => "UKT", "Tes Psikologi" => "Tes Psikologi", "Tes Kesehatan" => "Tes Kesehatan", "Tes Bakat" => "Tes Bakat");
            ...
            <div class="span12">
                <div class="grid simple ">
                    <div class="grid-title">
                        <h4>Laporan Pembayaran <?php echo $label_nama_periode . $label_jenjang; ?></h4>
                        <div class="tools">
                    ...
                    <div class="grid-body ">
                        <table class="table table-hover table-condensed" id="table-datatable" style="font-size:8px" width='100%'>
                            <thead>
                                <tr>
                                    <th width="1%">NO</th>
                                    <th width="14%">NAMA BANK</th>
                                    <th width="13%">JUMLAH PEMBAYAR</th>
                                    <th width="20%">JUMLAH TERBAYAR</th>
                                    <!-- <th width="20%">AKSI</th> -->
                                </tr>
                            </thead>
                        </table>
...
<script>
    ...
    function do_download() {
        ...
        window.open("<?php echo base_url('laporan/download_xls/'); ?>" + keterangan + "/" + kode_prodi);
    }
    ...
    let url = '<?php echo site_url('laporan/pembayaran/') ?>' + '/';
