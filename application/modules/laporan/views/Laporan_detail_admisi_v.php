...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Pembayaran Admisi</span><span style="font-size : 11pt ;"> >> Laporan Data per Semester</span></h3>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                <div class="nopad col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <label class="control-label" style="margin-top:10px">Jenjang</label>
                </div>
                <div class="nopad col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <?php
                    $ref_jnsKode = array("semua" => "Semua", "91" => "Admisi S1", "92" => "Profesi", "93" => "Pasca");
                ...
                <div class="nopad col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    foreach ($periode as $p) {
                        ...
                        if ($p->kode_periode == $s_periode) {
                            $text_periode = $p->nama_periode;
                        }
                        $i++;
                    }
                    echo form_dropdown('periode_db', $ref_periode, set_value('periode_db'), array('class' => 'chosen-select form-select drop_select', 'style' => 'width:100%')); ?>
                </div>
            </div>
            ...
            <div class="span12">
                <div class="grid simple ">
                    <div class="grid-title">
                        <h4>Laporan Pembayaran Admisi <?php echo  "<b>Periode " . $text_periode . $label_jenjang . "</b>"; ?></h4>
                        <div class="tools">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-lg-12 col-md-12 ">
                    ...
                    <div class="controls">
                        <p><b><?php echo "Periode " . $text_periode; ?></b></p>
                    </div>
                    <br>
                    ...
                    <br><br>
                    <label class="form-label">Jenjang Admisi</label>
                    <div class="controls">
                        <?php
                        $ref_jnsKode = array("" => "Semua", "92" => "Profesi", "93" => "Pasca");
...
<script>
    ...
    function do_download() {
        ...
        periode = $('[name=periode_db] option:selected').val();

        window.open("<?php echo base_url('laporan/download_xls_admisi/'); ?>" + jenjang + "/" + keterangan + "/" + kode_fakultas + "/" + kode_prodi + "/" + periode);
    }
    ...
    let url = '<?php echo site_url('laporan/detail_pembayaran_admisi/') ?>' + '/';
    ...
    $(document).ready(function() {
        ...
        $('[name=periode_db]').val('<?php echo $s_periode; ?>');

        $('[name=keterangan_db]').change(function(event, a) {
            keterangan = $('[name=keterangan_db] option:selected').val();
            periode = $('[name=periode_db] option:selected').val();

            oTable.api().ajax.url(url + periode + "/" + keterangan).load();
        });

        $('[name=periode_db]').change(function(event, a) {
            periode = $('[name=periode_db] option:selected').val();
            keterangan = $('[name=keterangan_db] option:selected').val();

            location.href = url + periode + "/" + keterangan;
        });

        oTable = $('#table-datatable').dataTable({
            "ajax": {
                "url": url + $('[name=periode_db] option:selected').val() + "/" + $('[name=keterangan_db] option:selected').val(),
                "type": "POST",
            },
            processing: true,
