...
<div class="page-content">
    ...
    <div class="content">
        <div class="page-title col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <h3><span class="semi-bold">Laporan Keringanan UKT</span><span style="font-size : 11pt ;"> >> Laporan Data per Semester</span></h3>
        </div>
            ...
            <div class="span12">
                <div class="grid simple ">
                    <div class="grid-title">
                        <h4>Laporan Keringanan UKT <?php echo  "<b>Periode " . $text_periode . $label_jenjang . "</b>"; ?></h4>
                        <div class="tools">
...
<script>
    ...
    function do_download() {
        ...
        window.open("<?php echo base_url('laporan/download_xls_ku/'); ?>" + jenjang + "/" + keterangan + "/" + kode_fakultas + "/" + kode_prodi + "/" + periode);
    }
    ...
    let url = '<?php echo site_url('laporan/keringanan_ukt/') ?>' + '/';
    ...
    $(document).ready(function() {
        ...
        $('[name=periode_db]').change(function(event, a) {
            ...
            location.href = "<?php echo base_url('laporan/keringanan_ukt/'); ?>" + periode + "/" + keterangan;
        });
